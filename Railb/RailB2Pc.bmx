...
If Screensize=1 Then 'earnings panel ----------------
	temp1=187; temp2=20; temp3=257;temp4=390; GUIFont=LoadGuiFont( "Ariel",16)
Else If screensize=2 Then
	temp1=217; temp2=25;temp3=357;temp4=480; GUIFont=LoadGuiFont( "Ariel",18)
Else
	temp1=263; temp2=30;temp3=488;temp4=640; GUIFont=LoadGuiFont( "Ariel",20)
End If	
Local W2P3:TGadget=CreatePanel(Temp1,Temp2,Temp3,Temp4,W2)

'use values below for Mac font sizes
'GUIFont=LoadGuiFont( "Ariel",20) GUIFont=LoadGuiFont( "Ariel",28) GUIFont=LoadGuiFont( "Ariel",36)
...
If Screensize=1 Then 'start panel ---------------------------
	temp1=3; temp2=20;temp3=180;temp4=390; GUIFont=LoadGuiFont( "Ariel",9.4)
Else If screensize=2 Then
	temp1=3; temp2=25;temp3=210;temp4=480; GUIFont=LoadGuiFont( "Ariel",12)
Else
	temp1=3; temp2=30;temp3=256;temp4=640; GUIFont=LoadGuiFont( "Ariel",14)
End If	
Local W2P1:TGadget=CreatePanel(Temp1,Temp2,Temp3,Temp4,W2,PANEL_GROUP,"Start")

'use values below for Mac font sizes
' GUIFont=LoadGuiFont( "Ariel",11) GUIFont=LoadGuiFont( "Ariel",14) GUIFont=LoadGuiFont( "Ariel",18)
