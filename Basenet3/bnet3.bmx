...
Const Mgame$="BSNV3d0_"'for the gnet server list, the game title
Const MGameID$="CpS005"' my GUID for this game or something similar...
...
End If
Local W1:TGadget = CreateWindow( "BSNetV3.0", 10,10,500,400,,WINDOW_CENTER | WINDOW_TITLEBAR)
...
Local W1Pan1Lab3:TGadget=CreateLabel("Welcome To "+"BSNetV3.0",20,2,410,17, W1Pan1,LABEL_CENTER)
		...
		Case EVENT_GADGETACTION
			Select EventSource()				
				...
				Case W1Pan1But2' about
					Tst1="BSNet is a GUI framework for GNet based two player games with"+Chr$(13)
					Tst1=Tst1+"basic chatand player selection built in. Hopefully multiple"+Chr$(13)
					Tst1=Tst1+"games can be coded without having to recode the GNet part."+Chr$(13)+Chr$(13)								
