...
Const Mgame$="VikV2d0_"'for the gnet server list, the game title
Const MGameID$="CpS004"' my GUID for this game or something similar...
...
End If
Local W1:TGadget = CreateWindow("The Viking Game V2.0", 10,10,500,400,,WINDOW_CENTER | WINDOW_TITLEBAR)
		...
		Case EVENT_GADGETACTION
			Select EventSource()				
				...
				Case W1Pan1But2' about
					...
					Tst1=Tst1+"'Brucy' for patience and great code."+Chr$(13)
...
Local W2P3B6:Tgadget' redraw game board button
...
If Screensize=1' 640 by 480
	...
	W2P3B6=CreateButton("Redraw Game Board",20,350,180,25,W2P3)
...
Else If Screensize=2' 800 by 600
	...
	W2P3B6=CreateButton("Redraw Game Board",20,447,227,30,W2P3)
...
Else'1024 by 768
	...
	W2P3B6=CreateButton("Redraw Game Board",30,600,261,35,W2P3)
...
Function DoInfo(Tf1:TGadget,Tb1:Byte)' Tf1=textfield name
	...
	If Tb1=1 Then ' show help screen	
		...
		AddTextAreaText(Tf1,Ts1)
		Ts1="REDRAW GAME BOARD."+S1+"Use this if the game"+S1+"board shows as black."+S1+S1
		Ts1=Ts1+"ENDING THE GAME."+S1+"If you choose to start"+S1+"a new game then you will"+S1
