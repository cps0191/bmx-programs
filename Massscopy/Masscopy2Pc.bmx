...
'Const Lz$="\"' note  / for mac build ------------- NB !!!!!!!!!!
...
Local W2P1:TGadget= CreatePanel(2,4,250,150,W2,PANEL_RAISED)
...
Local W2P2:TGadget= CreatePanel(258,4,276,150,W2,PANEL_RAISED)
...
Local W2P3:TGadget= CreatePanel(539,4,250,150,W2,PANEL_RAISED)
Tst1="Enter a start number for your new files" + Chr$(13) + "1 to 3000"
Local W2P3L1:Tgadget=CreateLabel(Tst1,5,5,238,35,W2P3,LABEL_CENTER)
...
'ChangeDir(lz+Lz+Lz)' ////to root'for mac
'ChangeDir(Lz+Lz+Lz+"users")' for mac
'ChangeDir(".."+Lz+Lz)'up a level' for mac
'ChangeDir(".."+Lz+Lz+Lz)' for mac
'ChangeDir("c:/")'for windows

Local W2P4:TGadget= CreatePanel(2,159,532,410,W2,PANEL_RAISED)
Local W2P4L1:Tgadget=CreateLabel("Select a folder to place your copies in.",5,3,250,20,W2P4,LABEL_CENTER)
Local W2P4Cb1:TGadget=CreateComboBox(5,27,60,80,W2P4)
DriveList(W2P4Cb1)' sets current directory to C:\ and puts avaliable drives in combo box specified
Local W2P4But1:TGadget=CreateButton("Folders - Up A Level",70,25,183,26,W2P4,LABEL_CENTER)
Local W2P4Lb1:TGadget=CreateListBox(5,56,250,274,W2P4)
...
Local W2P5:TGadget= CreatePanel(539,159,250,410,W2,PANEL_RAISED)
Local W2P5L1:Tgadget=CreateLabel("Your Choices",5,4,238,18,W2P5,LABEL_CENTER)
Local W2P5L2:Tgadget=CreateLabel("Search pattern for files to be copied.",5,30,238,18,W2P5,LABEL_CENTER)
...
Local W2P5L5:Tgadget=CreateLabel("Prefix for the files to be created.",5,90,238,18,W2P5,LABEL_CENTER)
...
Local W2P5L7:Tgadget=CreateLabel("Start number for created files.",5,150,238,18,W2P5,LABEL_CENTER)
...
Local W2P5But5:Tgadget=CreateButton("Exit",10,373,100,30,W2P5)
Local W2P5But6:Tgadget=CreateButton("Help",140,373,100,30,W2P5)

Local W2P6:TGadget= CreatePanel(2,3,788,566,W2,PANEL_RAISED)' help panel
Local W2P6Tf1:TGadget = CreateTextArea(129,20,530,488,W2P6,TEXTAREA_READONLY)

Local W2P6But1:Tgadget=CreateButton("Return",344,528,100,30,W2P6)
SetPanelColor(W2P6,200,255,200)
HideGadget(W2P6)


Local W2P7:TGadget= CreatePanel(2,3,788,331,W2,PANEL_RAISED)
SetPanelColor(W2P7,255,255,200)

Local W2P7Cb1:TGadget=CreateComboBox(5,6,60,80,W2P7)
DriveList(W2P7Cb1)' sets current directory to C:\ and puts avaliable drives in combo box specified
Local W2P7But1:TGadget=CreateButton("Folders - Up A Level",70,3,182,29,W2P7,LABEL_CENTER)
...
Local W2P7But2:Tgadget=CreateButton("Select All",535,265,100,25,W2P7)
Local W2P7But3:Tgadget=CreateButton("Clear All",670,265,100,25,W2P7)
Local W2P7But4:Tgadget=CreateButton("Add Files To Copy List",555,299,200,25,W2P7)
...
Local W2P8:TGadget= CreatePanel(2,337,788,233,W2,PANEL_RAISED)
...
Local W2P9:TGadget= CreatePanel(2,3,788,567,W2,PANEL_RAISED)'help screen
Local W2P9L1:Tgadget=CreateLabel("Files selected For copying",5,2,775,18,W2P9,LABEL_CENTER)
Local W2P9Lb2:TGadget=CreateListBox(5,25,774,55,W2P9)
Local W2P9Lb1:TGadget=CreateListBox(60,87,656,439,W2P9)
Local W2P9But1:Tgadget=CreateButton("Return",339,529,100,30,W2P9)
HideGadget(W2P9)

Local W2P10:TGadget= CreatePanel(2,3,788,260,W2,PANEL_RAISED)
...
Local W2P11:TGadget= CreatePanel(2,268,788,300,W2,PANEL_RAISED)
...
Local W2P11But2:Tgadget=CreateButton("Exit",5,260,100,30,W2P11)
Local W2P11But3:Tgadget=CreateButton("Return To Select Files",289,260,200,30,W2P11)
Local W2P11But4:Tgadget=CreateButton("Help",678,260,100,30,W2P11)
HideGadget(W2P11)
...
Repeat
	...
	Select EventID()
		...
		Case EVENT_GADGETACTION
			Select EventSource()		
				Case W2P4Cb1' drive select during destination folder setup
					Temp1=EventData()
					If Temp1<>-1 Then 'something selected
						Tst1=GadgetItemText(W2P4Cb1,SelectedGadgetItem(W2P4Cb1))+Lz
						ChangeDir(Tst1); Folderview(CurrentDir(),W2P4Lb1,W2P4But1)
						FileView(CurrentDir(),W2P4Lb2)
						ClearGadgetItems(W2P4Lb4); AddGadgetItem(W2P4Lb4,CurrentDir())				
					End If
				
				Case W2P7Cb1' drive select during file select
					Temp1=EventData()
					If Temp1<>-1 Then 'something selected		
						Tst1=GadgetItemText(W2P7Cb1,SelectedGadgetItem(W2P7Cb1))+Lz
						ChangeDir(Tst1); Folderview(CurrentDir(),W2P7Lb1,W2P7But1)
						FileView2(CurrentDir(),W2P7Lb2,Exten)
						ClearGadgetItems(W2P7Lb4)
						AddGadgetItem(W2P7Lb4,CurrentDir())
						ClearGadgetItems(W2P7Lb3)		
				...
				Case W2P5But4 ' continue to file select screen
					If Right$(CurrentDir(),1)="\" Or Right$(CurrentDir(),1)="/" Then
						Desfold=CurrentDir()					
					Else
					...
					'ChangeDir(Lz+Lz+Lz+"users")'mac ver
					ChangeDir("c:\")'win ver
					Folderview(CurrentDir(),W2P7Lb1,W2P7But1)
					FileView2(CurrentDir(),W2P7Lb2,Exten)
					ClearGadgetItems(W2P7Lb4)
...
Function DriveList(Tv1:Tgadget)' Tv1 combobox for output. only used by windows version. Sets current dir to c:/
	Local Tx1%=0; Local Ts1$=""
	For Tx1=99 To 122
		Ts1=Chr$(Tx1)+":"+Lz
		If ChangeDir(Ts1) Then
			Ts1=Left$(Ts1,2)
			AddGadgetItem(Tv1,Ts1)		
		End If 
	Next
	SelectGadgetItem(Tv1,0)
	Ts1="c:"+Lz
	ChangeDir(Ts1)
End Function
...
Function FolderView(Dir$,Tv:TGadget,Bv:TGadget)
	...
	ClearGadgetItems(Tv)
	Tx1=ReadDir(Dir)
	If Len(Dir)=3 Then'at the root PC
	'If Dir=Lz Then ' at the root Mac
		DisableGadget(Bv)
	Else
		EnableGadget(Bv)	
	End If
...
AddTextAreaText(Tf,"It is a good idea to start with an empty destination folder.... Have Fun !")
