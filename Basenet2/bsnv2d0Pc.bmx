...
Const Mgame$="BSNV2d0_"'for the gnet server list, the game title
Const MGameID$="CpS003"' my GUID for this game or something similar...
...
GameCon.Initilise1(W2P3L1,W2P3L2,W2P3B2,W2P3B5,W2P3B4)
				...
				End Rem	
					Select GMType
						...
						Case "05"' opponent has dissconected from you
							...
							HideGadget(W2GP6); HideGadget(W2P4); ShowGadget(W2P3)
							ExButCon=0													
							AmCon=False; ConSet=False; SevStatus=False
							MesPan.Display(0); GameCon.Display0()							
						...
						Case "07" ' opponent answering yes start a new game
							If GRec<>GRecNum Then 'act on new message sent
								...
								ExitCon.Display0(); HideGadget(W2GP6); ShowGadget(W2P3)
						...
						Case "21" 'client ready to start game
							...
							HideGadget(W2GP4); ShowGadget(W2P3); ShowGadget(W2P1B1); Ggo=True
							' game start vars set
			...
			Else' AmCon=false no conection acknowlaged				
				Select GMType
					...
					Case "02"' message from server to client yes you can join my game
						...
						GMsg=Right(GMsg,Len(GMsg)-Temp1)
						MSec=GetCode(GMsg); GameCon.Display1(OpName); Ggo=True						
		...
		Select EventID()
			...
			Case EVENT_GADGETPAINT
  	 		...
  	 		Case EVENT_MOUSEDOWN
	 			Select EventData()
					Case 1 'left click	only allow if its your move and GTick=0 ie previous message acknowlaged	
					...
					Case W2GP6B5' yes 1=exit, 2=dissconnect or 3=new game
						Select ExButCon
							...
							Case 3' yes lets play again
								...
								' reset game vars for fresh game
...
Type PanCon3' methods for manipulating the game control panel
	Field Gad:TGadget[5]' number of gadgets in the panel
	...
	Method Display1(Tst1$)' you are connected display
		...
		HideGadget(Gad[2]); HideGadget(Gad[4]); ShowGadget(Gad[1])							
	End Method	
